...
game_cards = [
    card_html(16, 175, 174, 171, '#282e8b', 'PC GAMES', '勝率を変える<br>最強セッティング', 'images/3af11f3dcf672c9b4903491a082063fc3bbb9287.png', 'position:absolute; left: 85px; top: 49px; width:110px; height:auto; object-fit:contain; opacity:0.9;'),
    card_html(200, 175, 174, 171, '#e70012', 'CONSOLES', '今が買い時の<br>Switch 2', 'images/f20f8ba4e4f9ffd597b8b791eaa4fafb3b651c75.png', 'position:absolute; right:-60px; bottom:-30px; width:190px;'),
    card_html(16, 356, 174, 171, '#4c7df9', 'GAMING GEAR', 'プロ仕様<br>ギア特集', 'images/bdfa442346e670eb4ac457ba91ff00e1eff7aab6.png', 'position:absolute; right: -25px; bottom: -20px; width:123px; transform: scaleX(-1);'),
    card_html(200, 356, 174, 352, '#010212', '', 'Fakerセレクト<br>2026 T1優勝ギア特集', 'images/8a8f2c97240b2c25f73107ed67960f33515a8e46.png', 'position:absolute; width: 616px; left:-190px; top:-44px; max-width: none; opacity:0.6;', None, True, False),
    ...
    card_html(16, 718, 358, 91, '#010c18', '', 'プロが使う最強セッティング', 'images/dc537cf7ec9578f6e9624ff599e91173d523c8a3.png', 'position:absolute; top: 18px; left: 220px; width: 104px; height:53px; object-fit:contain;', None, False, False)
]
game_html = '<div style="position:relative; height: 680px;">' + ''.join(game_cards) + '</div>'

sports_cards = [
    card_html(16, 175, 174, 171, '#222138', 'TENNIS', 'テニス<br>始めましょうか', 'images/1b270d270fdb35cee2e2c97d12427e158ca2bc85.png', 'position:absolute; width:131px; height:142px; left: 70px; top: 48px; object-fit:cover;'),
    card_html(200, 175, 174, 171, '#213828', 'GOLF', '飛距離200ヤード<br>新素材ドライバー', 'images/fe3e8dc892ca1b216b02fb2f38e33ebcb3e34789.png', 'position:absolute; width:163px; height:204px; left:42px; top:-17px; object-fit:cover;', '<div style="position:absolute; bottom:0; left:0; right:0; height:114px; background:linear-gradient(to top, rgba(0,0,0,0.6), transparent);"></div>'),
    card_html(16, 356, 174, 171, '#97b9b8', 'RUNNING', '2026年の目標に向け<br>ランニングシューズ', 'images/3939934e844e19c0205dbacae2d94d4d564bfc52.png', 'position:absolute; width:200px; height:200px; right:-50px; top:-5px; transform: scaleX(-1); object-fit:cover;', '<div style="position:absolute; bottom:0; left:0; right:0; height:95px; background:linear-gradient(to top, rgba(0,0,0,0.4), transparent);"></div>'),
    card_html(200, 356, 174, 352, '#010212', '', 'Naomi Osaka流<br>強打の極意', 'images/397b8016f4fb3986abc42562d50bb175a946167a.png', 'position:absolute; width:357px; height:421px; left:-68px; top:31px; object-fit:cover; opacity: 0.8', '<div style="position:absolute; bottom:0; left:0; right:0; height:100px; background:linear-gradient(to top, rgba(0,0,0,0.4), transparent);"></div>', True, False),
    ...
    card_html(16, 718, 358, 91, '#466136', '', '初級者に人気のラケットTOP5', 'images/1b2d9139889a6fced8b130e89b1707ea16f75a80.png', 'position:absolute; width:147px; height:221px; left:211px; top:-61px; object-fit:cover;', None, False, False)
]
sports_html = '<div style="position:relative; height: 680px;">' + ''.join(sports_cards) + '</div>'

fashion_cards = [
    card_html(16, 175, 174, 352, '#eaeaea', 'BAG', '星野源セレクト<br>PORTER TANKER', 'images/0a480fd69ed6b7d0470ca4942ba25022b6b4663e.png', 'position:absolute; width: 327px; height:440px; left:-124px; top:-82px; mix-blend-mode:multiply; object-fit:cover;', '', False, True, 'black'),
    ...
    card_html(200, 356, 174, 171, '#25242c', 'COUPON', '関心ブランド<br>セールまとめ', None, '', '<div style="position:absolute; top:50px; left:0; right:0; text-align:center;"><p style="font-size:24px; font-weight:900; color:white; margin:0; padding: 0 16px; text-align:left; line-height:1.3;">関心ブランド<br>セールまとめ</p></div>', False, True),
    card_html(16, 537, 358, 91, '#355375', '', '#限定 ナイキ ブック2 公開', 'images/60377435440851c08f633eba2e9569cb74fa0248.png', 'position:absolute; width:364px; height:114px; left:-1px; top:-10px; object-fit:cover; mix-blend-mode: color-dodge;', None, False, True),
    card_html(16, 638, 174, 171, '#000', 'BEAMS', '2026年春の<br>Levi’s × BEAMS<br>コラボ発売', 'images/b47e35420a10978c1b796b1cbccd74d623b5c0fc.png', 'position:absolute; width:174px; height:171px; left:0px; top:0px; object-fit:cover; opacity:0.8;', '<div style="position:absolute; bottom:0; left:0; right:0; height:80px; background:linear-gradient(to top, rgba(0,0,0,0.8), transparent);"></div>', False, True),
    card_html(200, 638, 174, 171, '#000', 'ACCESSORY', '最近購入した Apple Watch<br>ストラップおすすめ', 'images/ba5cbf5b981ef84560b765b0de11fbafe00cb268.png', 'position:absolute; width:174px; height:171px; left:0px; top:0px; object-fit:cover; opacity:0.9;', '<div style="position:absolute; bottom:0; left:0; right:0; height:80px; background:linear-gradient(to top, rgba(0,0,0,0.7), transparent);"></div>', False, True)
]
fashion_html = '<div style="position:relative; height: 680px;">' + ''.join(fashion_cards) + '</div>'

kitchen_cards = [
    card_html(16, 175, 174, 171, '#222138', 'POTS', '2026キッチン<br>トレンド', 'images/1baeb382aafba0a98c721a8ed94425e35305704e.png', 'position:absolute; width:107px; height:102px; left: 96px; top: 48px; object-fit:cover;'),
    card_html(200, 175, 174, 171, '#622121', 'FRYING PANS', 'ステーキをムラなく<br>焦けるフライパン', 'images/a7f9f1718fc5ecf987d89908fdffebac9d6f5371.png', 'position:absolute; width:157px; height:74px; left: 63px; top: 47px; object-fit:cover;', '<div style="position:absolute; bottom:0; left:0; right:0; height:80px; background:linear-gradient(to top, rgba(0,0,0,0.4), transparent);"></div>'),
    card_html(16, 356, 174, 171, '#97b9b8', 'MULTI COOKERS', '帰宅で5分で<br>本格ディナー（美食）', 'images/3540db8dba331fe503fc44d0065db853f9283497.png', 'position:absolute; width:117px; height:117px; left: 57px; top: 19px; object-fit:cover;', '<div style="position:absolute; bottom:0; left:0; right:0; height:95px; background:linear-gradient(to top, rgba(0,0,0,0.4), transparent);"></div>'),
    card_html(200, 356, 174, 352, '#1f353f', '', 'ドラマグランメゾン発<br>ヒットアイテム', 'images/a958eefb1b6f856c272750b696159d3806e2096f.png', 'position:absolute; width:574px; height:323px; left:-1px; top:30px; object-fit:cover;', '<div style="position:absolute; bottom:0; left:0; right:0; height:114px; background:linear-gradient(to top, rgba(0,0,0,0.6), transparent);"></div>', True, False),
    ...
    card_html(16, 718, 358, 91, '#0032be', '', '人気インフルエンサー コラボ', 'images/fd795b966d00d7e719e8c157aec2458123b40761.png', 'position:absolute; width:108px; height:39px; right:12px; top:26px; object-fit:cover;', None, False, False)
]
